    ...
    post {
        always {
           ...
           // script {
            ...
            publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: true, reportDir: 'cypress/reports', reportFiles: 'index.html', reportName: 'HTML_20Report/index.html', reportTitles: ''])
            deleteDir()
        }
    }
}
